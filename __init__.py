...
from .Options import BombHOptions, bomberman_hero_option_groups
...
class BombHWebWorld(WebWorld):
    ...
    option_groups = bomberman_hero_option_groups
    tutorials = [setup_en]

class BombHWorld(World):
    """Bomberman Hero is a 3D platformer for the N64! 
    Unique from the other two N64 Bomberman games and pretty much every game of the series preceding it, Bomberman can jump in this game and throw bombs! 
    Make your way through a series of platformy levels and collect shiny gems to increase your score.
    Stage progression is now gated by finding the idividual stages as items and progression of stages is now non linear.
    Collect locations by clearing stages, getting enough clear points, finding radios or collecting adok bombs."""
    ...
    def create_stage_list(self, total) -> None:
        temp_stages = copy.deepcopy(stage_names)
    ...
    def fill_slot_data(self) -> Dict[str, Any]:
        return {
            ...
            "gem_check_total": self.options.gem_check_total.value, 
            "adok_bombs": self.options.adok_bombs.value, 
            "radio": self.options.radio.value
        }
    ...
    def generate_output(self, output_directory: str):
        ...
        # Next two lines used only for generating poptracker files
