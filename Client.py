...
from .Locations import point_clears
...
class BombHClient(BizHawkClient):
    ...
    async def validate_rom(self, ctx: "BizHawkClientContext") -> bool:
        ...
        rom_data = await bizhawk.read(
            ...
            (0xC,0x4, "ROM"), # 4 Save File (Unused)
    ...
    async def game_watcher(self, ctx: "BizHawkClientContext") -> None:
        ...
        try:
            ram_data = await bizhawk.read(
                ...
                (0x50000, 0x4, "RDRAM"), #B Expansion Memory
                ]
            )#0x16523F
            outbound_writes = []
            ...
            for loc in ctx.checked_locations:
                if loc in point_clears:
                    outbound_writes.append((point_clears[loc], (0x05).to_bytes(1, "little") , "RDRAM"))
